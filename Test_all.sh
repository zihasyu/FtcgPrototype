run_ftcg() {
  ...
  sudo echo 3 > /proc/sys/vm/drop_caches
  ./Ftcg -i $path -c 0 -m 7 -n $num > BF$name.txt  
}
...
run_ftcg /mnt/dataset2/automake_tarballs _automake $fileNum
run_ftcg /mnt/dataset2/bash_tarballs _bash $fileNum
run_ftcg /mnt/dataset2/coreutils_tarballs _coreutils $fileNum
run_ftcg /mnt/dataset2/fdisk_tarballs _fdisk $fileNum
