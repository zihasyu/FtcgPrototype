#include "../../include/FP-lz4Baseline-implement.h"
...
feature_t FPLz4BaselineImplement::find_most_freq_feature(const set<string> chunks, set<feature_t> usedFeatures)
{
...
feature_t FPLz4BaselineImplement::find_most_correlated_feature(feature_t feature, set<feature_t> usedFeature)
{
...
void FPLz4BaselineImplement::SetInputMQ(ProduceConsumerQueue<Chunk_t> *mq)
{
    recieveQueue = mq;
    return;
}
