...
static const uint32_t CHUNK_QUEUE_SIZE = 65534;
static const uint32_t THREAD_STACK_SIZE = 8 * 1024 * 1024;

const int HASH_DIM = 16;               // 哈希维度
const int NUM_BUCKETS = 1 << HASH_DIM; // 哈希桶的数量
using HashSignature = std::bitset<HASH_DIM>;
using HashTable = std::unordered_map<HashSignature, std::vector<int>>;
#define CHUNK_HASH_SIZE 32
#define MAX_GROUP_SIZE 8
#define EXPERIMENT_CHUNK_NUM 8192
...
static const uint64_t CONTAINER_CACHE_SIZE = 64;
